...
var Module = typeof newJQ != "undefined" ? newJQ : {};
...
function _emscripten_resize_heap(requestedSize) {
 ...
 for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
  var overGrownHeapSize = oldSize * (1 + .5 / cutDown);
...
var _fflush = Module["_fflush"] = function() {
 return (_fflush = Module["_fflush"] = Module["asm"]["H"]).apply(null, arguments);
};
...
var ___funcs_on_exit = Module["___funcs_on_exit"] = function() {
 return (___funcs_on_exit = Module["___funcs_on_exit"] = Module["asm"]["K"]).apply(null, arguments);
};
